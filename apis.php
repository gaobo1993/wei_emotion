...
<div class="panel-body">
    <table class="table table-hover">
        ...
        <tr>
            <td><a href="http://weiconnect.codingapp.com/users">weiconnect.codingapp.com/users</a></td>
            <td>返回所有登录过的用户的uid和用户名</td>
        </tr>
        <tr>
            <td><a href="http://weiconnect.codingapp.com/posts/<uid>">weiconnect.codingapp.com/posts/&lt;uid&gt;</a></td>
            <td>返回uid为&lt;uid&gt;的用户的最近微博（不超过100条）</td>
        </tr>
        <tr>
            <td><a href="http://weiconnect.codingapp.com/posts/<uid>?keywords=1">weiconnect.codingapp.com/posts/&lt;uid&gt;?keywords=1</a></td>
